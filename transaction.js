...
<body>
    <div class="container">
        <div class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="pos.html"><i class="fas fa-shopping-cart"></i> Point of Sale</a></li>
                ...
                <li><a href="transactions.html" class="active"><i class="fas fa-receipt"></i> Transactions</a></li>
        ...
        <div class="main-content">
                ...
                <h2>Sales Transactions</h2>
                 <div class="user-info">
                    <div class="user-profile">
                        <div>
                            <div>User</div>
                            <div style="font-size: 12px; color: var(--gray);">Admin</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom: 20px;">
                <div style="display: flex; gap: 15px; flex-wrap: wrap;">
                    ...
                    <div class="form-group" style="margin-bottom: 0; align-self: flex-end;">
                        ...
                        <button class="btn" id="resetFilters" style="margin-left: 10px;">
            ...
            <div class="card">
                <div class="table-header">
                    ...
                    <div>
                        <button class="btn" id="exportTransactionsBtn">
    ...
    <div id="transactionModal" class="modal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center;">
        <div class="card" style="width: 700px; max-width: 90%; max-height: 90vh; overflow-y: auto;">
            <div class="table-header">
                <h3>Transaction Details</h3>
                <button class="close-btn" style="background: none; border: none; font-size: 20px; cursor: pointer;" onclick="transactionsManager.closeTransactionModal()">&times;</button>
            </div>
